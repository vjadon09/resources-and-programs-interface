                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">                            
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                                Take your skills to the next level with our hands-on, interactive workshops! Led by industry experts, these engaging sessions are designed to provide practical knowledge and real-world solutions. Whether you're looking to enhance your team’s capabilities or learn new strategies, our workshops offer a collaborative environment to ask questions, share ideas, and gain valuable insights. Ready to get started? Dive in and start learning with us today! 
                                </p>
                                <div className="flex justify-center my-4">
